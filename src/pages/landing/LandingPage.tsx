...
import { CreditCard, ChevronDown, Cpu, Globe, Fingerprint, ChevronRight, FileCheck, ShieldCheck } from 'lucide-react';
...
export const LandingPage = () => {
  ...
  const [activeSdk, setActiveSdk] = useState<'presence' | 'media' | 'forensic'>('presence');
    ...
    <div className="min-h-screen bg-[#050505] text-white selection:bg-primary selection:text-black relative font-sans overflow-x-hidden">
      ...
      <section className="relative z-10 flex flex-col items-center justify-center min-h-screen px-4 overflow-hidden pt-20">
        ...
        <div className="z-10 text-center max-w-5xl mx-auto space-y-12">
          ...
          <div className="space-y-6">
              ...
              >
                <span className="text-white font-medium block mb-4 text-2xl">The first verifier that proves physical humanity without storing user data.</span>
                Traditional security analyzes <span className="italic">behavior</span>. GUAW verifies <strong className="text-white">physical possibility</strong>. <br className="hidden md:block" />
                <span className="text-emerald-400 font-bold">Trusted Execution Integrity.</span> A hardened Rust parent process enforces invariants that software alone cannot falsify.
                <br />
                <span className="text-[10px] uppercase tracking-[0.2em] font-bold text-primary/70 mt-8 block">
                    Zero-Knowledge (Groth16) · Secure Enclaves · WORM Storage · Distributed Entropy
                </span>
              </motion.p>
          </div>
          ...
          >
            <Link to="/console/register" className="relative group px-12 py-6 rounded-2xl bg-white text-black font-black uppercase tracking-widest text-xs overflow-hidden transition-all active:scale-95 shadow-[0_20px_40px_-10px_rgba(255,255,255,0.2)]">
              <span className="relative z-10 group-hover:text-white transition-colors duration-500">Start Free Trial</span>
              <div className="absolute inset-0 bg-gradient-to-br from-emerald-600 to-emerald-800 translate-y-full group-hover:translate-y-0 transition-transform duration-500 ease-out" />
      ...
      >
        ...
        <div className="max-w-6xl mx-auto space-y-32 relative z-10">
            ...
            <section className="py-20 relative overflow-hidden">
                ...
                <div className="overflow-x-auto">
                    ...
                    <tbody className="text-sm font-light">
                        ...
                        <td className="py-6 px-6 text-emerald-400 font-bold bg-primary/5 border-x border-primary/10">~45µs (ZK Verification)</td>
                        ...
                        <td className="py-6 px-6 text-emerald-500/80">$1/1k (Reduced Tier)</td>
            ...
            <section className="py-20 relative overflow-hidden border-t border-white/5">
                <div className="absolute inset-0 bg-[radial-gradient(circle_at_70%_50%,rgba(56,189,248,0.03),transparent_50%)] pointer-events-none" />
                ...
                <div className="grid md:grid-cols-3 gap-6 max-w-5xl mx-auto mb-16 relative z-10">
                    <div className="p-8 rounded-[2.5rem] bg-white/[0.02] border border-white/5 hover:border-sky-500/30 transition-all duration-700 group backdrop-blur-3xl overflow-hidden">
                        <div className="absolute -inset-1 bg-sky-500/5 blur-xl opacity-0 group-hover:opacity-100 transition-opacity" />
                        <h3 className="text-sky-400 font-bold uppercase tracking-widest text-xs mb-4">Sensor-level Noise</h3>
                        <p className="text-gray-400 text-[13px] leading-relaxed relative z-10">Verifies structural entropy of capturing devices (CMOS/Microphone), impossible to perfectly synthesize by AI models.</p>
                    </div>
                    <div className="p-8 rounded-[2.5rem] bg-white/[0.02] border border-white/5 hover:border-emerald-500/30 transition-all duration-700 group backdrop-blur-3xl overflow-hidden">
                        <div className="absolute -inset-1 bg-emerald-500/5 blur-xl opacity-0 group-hover:opacity-100 transition-opacity" />
                        <h3 className="text-emerald-400 font-bold uppercase tracking-widest text-xs mb-4">Zero Data Upload</h3>
                        <p className="text-gray-400 text-[13px] leading-relaxed relative z-10">Runs completely client-side. The media never touches our servers. We only receive cryptographic proofs.</p>
                    </div>
                    <div className="p-8 rounded-[2.5rem] bg-white/[0.02] border border-white/5 hover:border-primary/30 transition-all duration-700 group backdrop-blur-3xl overflow-hidden">
                        <div className="absolute -inset-1 bg-primary/5 blur-xl opacity-0 group-hover:opacity-100 transition-opacity" />
                        <h3 className="text-primary font-bold uppercase tracking-widest text-xs mb-4">11ms Verification</h3>
                        <p className="text-gray-400 text-[13px] leading-relaxed relative z-10">Real-time validation for video KYC, streams, and voice data without blocking or delaying the user experience.</p>
                    </div>
                </div>

                <div className="flex justify-center mt-12 mb-24 relative z-10">
                    <button onClick={() => {
                 ...
                 <div className="space-y-8 relative z-10">
                     ...
                     <div className="space-y-4">
                         {[
                             ...
                             <div key={i} className="flex items-center gap-4 text-emerald-500/60 font-mono text-xs tracking-tight group/item">
            ...
            <div className="lg:w-1/2 space-y-8">
                ...
                <div className="flex gap-4 p-1 bg-white/5 rounded-xl border border-white/10 w-fit">
                    ...
                    <button 
                        ...
                        className={`px-4 py-2 rounded-lg text-xs font-bold transition-all ${activeSdk === 'media' ? 'bg-emerald-500 text-black shadow-[0_0_20px_rgba(16,185,129,0.3)]' : 'text-gray-500 hover:text-white'}`}
                    >
                        Media (Guaw)
                    </button>
                    <button 
                        onClick={() => setActiveSdk('forensic')}
                        className={`px-4 py-2 rounded-lg text-xs font-bold transition-all ${activeSdk === 'forensic' ? 'bg-gray-300 text-black shadow-[0_0_20px_rgba(209,213,219,0.4)]' : 'text-gray-500 hover:text-white'}`}
                    >
                        Audit (SDK)
                    </button>
                </div>
                ...
                <div className="flex flex-col gap-4 pt-4">
                    <div className="flex items-center gap-4 text-sm text-gray-400">
                        <div className={`transition-all duration-500 w-1.5 h-1.5 rounded-full ${activeSdk === 'presence' ? 'bg-primary' : activeSdk === 'media' ? 'bg-emerald-500 shadow-[0_0_8px_rgba(16,185,129,0.5)]' : 'bg-gray-400 shadow-[0_0_8px_rgba(255,255,255,0.2)]'}`} /> Zero Personal Data Collection
                    </div>
                    <div className="flex items-center gap-4 text-sm text-gray-400">
                        <div className={`transition-all duration-500 w-1.5 h-1.5 rounded-full ${activeSdk === 'presence' ? 'bg-primary' : activeSdk === 'media' ? 'bg-emerald-500 shadow-[0_0_8px_rgba(16,185,129,0.5)]' : 'bg-gray-400 shadow-[0_0_8px_rgba(255,255,255,0.2)]'}`} /> Native Web & Mobile SDKs
                    </div>
                    <div className="flex items-center gap-4 text-sm text-gray-400">
                        <div className={`transition-all duration-500 w-1.5 h-1.5 rounded-full ${activeSdk === 'presence' ? 'bg-primary' : activeSdk === 'media' ? 'bg-emerald-500 shadow-[0_0_8px_rgba(16,185,129,0.5)]' : 'bg-gray-400 shadow-[0_0_8px_rgba(255,255,255,0.2)]'}`} /> Verifiable Fraud Proofs
                    </div>
                </div>
            </div>
                    ...
                    {activeSdk === 'presence' ? (
                        ...
                        >
                            <CodeBlock 
                                ...
                                filename="Terminal"
                                className="border-gray-400/20 shadow-[0_0_40px_-20px_rgba(56,189,248,0.2)]"
                            />
                            <CodeBlock 
                                language="typescript"
                                ...
                                filename="media.ts"
                                className="border-gray-400/10 shadow-[0_0_30px_-15px_rgba(56,189,248,0.1)]"
                            />
                        </motion.div>
                    ) : (
                        <motion.div 
                        ...
                        >
                            <CodeBlock 
                                ...
                                filename="Terminal"
                                className="border-gray-500/20 shadow-[0_0_40px_-20px_rgba(168,85,247,0.2)]"
                            />
                            <CodeBlock 
                                language="typescript"
                                ...
                                filename="audit.ts"
                                className="border-gray-500/10 shadow-[0_0_30px_-15px_rgba(168,85,247,0.1)]"
                            />
                        </motion.div>
                    )}
                </AnimatePresence>
      ...
      <section className="py-32 px-4 relative bg-[#050505] border-t border-white/5 overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-16 items-center relative z-10">
             <div className="space-y-8">
                 <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-indigo-500/10 text-indigo-400 text-[10px] font-black uppercase tracking-widest border border-indigo-500/20 shadow-[0_0_20px_rgba(99,102,241,0.2)]">
                 ...
                 <h2 className="text-5xl font-bold tracking-tighter text-white leading-tight relative group">
                     Hardware is the final<br/>
                     <span className="text-gray-600 group-hover:text-indigo-400 transition-colors duration-700 italic">arbiter.</span>
                     <div className="absolute -left-4 top-0 w-1 h-full bg-gradient-to-b from-indigo-500/0 via-indigo-500/40 to-indigo-500/0" />
                 </h2>
                 <p className="text-gray-400 text-lg font-light leading-relaxed max-w-xl relative">
                     <span className="absolute -left-8 top-2 text-indigo-500/20 font-mono text-xs">01</span>
                  ...
                  <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 pt-6">
                      <div className="p-5 rounded-2xl bg-white/[0.03] border border-white/5 space-y-2 hover:bg-white/[0.05] hover:border-indigo-500/30 transition-all duration-300 group">
                          <div className="text-indigo-400 font-mono text-[10px] font-bold uppercase tracking-widest group-hover:text-indigo-300 transition-colors truncate">Authority Matrix</div>
                          <div className="text-xl font-bold text-white tracking-tight">Computation <span className="text-[10px] text-indigo-400/50">SEALED</span></div>
                       ...
                       <div className="p-5 rounded-2xl bg-white/[0.03] border border-white/5 space-y-2 hover:bg-white/[0.05] hover:border-blue-500/30 transition-all duration-300 group">
                          <div className="text-blue-400 font-mono text-[10px] font-bold uppercase tracking-widest group-hover:text-blue-300 transition-colors truncate">Isolated TEE</div>
                       ...
                       <div className="p-5 rounded-2xl bg-white/[0.03] border border-white/5 space-y-2 hover:bg-white/[0.05] hover:border-sky-500/30 transition-all duration-300 group">
                           <div className="text-sky-400 font-mono text-[10px] font-bold uppercase tracking-widest group-hover:text-sky-300 transition-colors truncate">Attestation Proof</div>
                       ...
                       <div className="p-5 rounded-2xl bg-white/[0.03] border border-white/5 space-y-2 hover:bg-white/[0.05] hover:border-emerald-500/30 transition-all duration-300 group">
                           <div className="text-emerald-400 font-mono text-[10px] font-bold uppercase tracking-widest group-hover:text-emerald-300 transition-colors truncate">WORM Storage</div>
             ...
             >
                 <div className="absolute -inset-1 bg-gradient-to-r from-indigo-500/20 to-blue-500/20 blur-xl opacity-50 group-hover:opacity-100 transition-opacity duration-700" />
                 <div className="relative rounded-[2.5rem] bg-[#0A0A0A]/90 border border-white/10 p-12 shadow-2xl backdrop-blur-3xl overflow-hidden group-hover:border-indigo-500/30 transition-all duration-700">
                     ...
                     <div className="space-y-6 relative z-10">
                         <div className="text-[10px] font-black text-indigo-400 uppercase tracking-widest italic mb-2">Technical Reference</div>
                         ...
                         <Link to="/docs" className="inline-flex items-center gap-2 text-indigo-400 text-[10px] font-black uppercase tracking-widest hover:text-white transition-colors">
      ...
      >
         ...
         <div className="max-w-6xl mx-auto space-y-20 relative z-10">
              ...
              <div className="text-center space-y-6 max-w-3xl mx-auto">
                  <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-emerald-500/10 text-emerald-400/90 text-[10px] font-black uppercase tracking-widest border border-emerald-500/20 shadow-[0_0_20px_rgba(16,185,129,0.15)]">
                   ...
                   <h2 className="text-5xl font-bold tracking-tighter text-white leading-tight relative group">
                      ...
                      <span className="text-gray-600 group-hover:text-emerald-400 transition-colors duration-700">using Physical Invariants — not AI guesses.</span>
                  ...
                  <p className="text-gray-400 text-xl font-light leading-relaxed relative">
                      ...
                      Deepfakes simulate pixels. GUAW verifies <strong className="text-white underline decoration-emerald-500/30 underline-offset-8">sensor-level entropy</strong>.
                  </p>
              </div>
              ...
              <div className="grid md:grid-cols-2 gap-12 items-start">
                  ...
                  <div className="p-8 rounded-2xl bg-white/[0.02] border border-white/5">
                      ...
                      <div className="space-y-6">
                          ...
                          <div className="space-y-2">
                              <div className="flex items-center gap-3">
                                  <div className="w-8 h-8 rounded-lg bg-gray-300/10 border border-gray-300/20 flex items-center justify-center text-gray-300 font-bold text-sm">2</div>
                          ...
                          <div className="space-y-2">
                              <div className="flex items-center gap-3">
                                  <div className="w-8 h-8 rounded-lg bg-gray-500/10 border border-gray-500/20 flex items-center justify-center text-gray-500 font-bold text-sm">3</div>
              ...
              {/* Hardware Integrity / Axiomatic Veto (Tier 100) */}
              <div className="p-16 rounded-[4rem] bg-indigo-500/[0.02] border border-indigo-500/10 relative overflow-hidden group">
                  ...
                  <div className="max-w-3xl mx-auto space-y-8 text-center relative z-10">
                      ...
                      <h3 className="text-4xl font-black text-white tracking-tighter uppercase leading-tight">
                          ...
                          <span className="text-gray-600 group-hover:text-indigo-400/80 transition-colors duration-700">doubt authority.</span>
                      </h3>
                      <p className="text-lg text-gray-400 font-light leading-relaxed italic max-w-2xl mx-auto">
                          "Hardware Integrity Veto." If a command contradicts the physical laws of the universe (e.g., bit-flips from radiation or AI injection), the hardware <strong className="text-white">VETOS</strong> the administrator.
                      </p>
                      <div className="pt-6">
               ...
               <div className="grid lg:grid-cols-2 gap-16 items-center">
                   <div className="space-y-8">
                       ...
                       <div className="grid grid-cols-2 gap-4">
                           ...
                           <div className="p-6 rounded-2xl bg-white/[0.02] border border-white/5 space-y-2">
                               <div className="text-gray-400 font-mono text-[10px] font-bold uppercase tracking-widest">Quality Witness</div>
                   ...
                   <div className="relative group">
                        <div className="absolute -inset-1 bg-gradient-to-r from-emerald-500/20 to-emerald-800/20 blur-xl opacity-50" />
                        <div className="relative p-1 bg-white/5 rounded-3xl overflow-hidden border border-white/10">
                            <div className="bg-[#0A0A0A] rounded-[1.4rem] p-10 space-y-8">
                                <div className="flex justify-between items-center border-b border-white/5 pb-6">
                                    ...
                                    <div className="px-3 py-1 rounded bg-gray-400/10 text-gray-400 text-[10px] font-black border border-gray-400/20 uppercase tracking-widest">GOLD SEAL</div>
                                </div>
              ...
              <div className="p-10 rounded-3xl bg-white/[0.01] border border-white/5 text-center space-y-10 relative overflow-hidden group">
               ...
               {/* Legacy Tiers Removed for Unification */}
      ...
      <section className="py-32 px-4 relative bg-[#050505] border-t border-white/5 overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center space-y-8 relative z-10">
          <motion.div
            ...
            transition={{ duration: 0.8 }}
          >
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-emerald-500/10 text-emerald-400 text-[10px] font-black uppercase tracking-widest border border-emerald-500/20 mb-8 shadow-[0_0_20px_rgba(16,185,129,0.15)]">
              <span className="w-1.5 h-1.5 rounded-full bg-emerald-500 animate-pulse" />
              Sovereign Principle
            </div>
            <h2 className="text-5xl font-bold tracking-tighter text-white leading-tight relative group">
              If we can't prove it,<br/>
              <span className="text-gray-600 group-hover:text-white transition-colors duration-700 italic">we don't run it.</span>
              <div className="absolute -inset-x-20 top-0 h-full bg-gradient-to-r from-transparent via-emerald-500/5 to-transparent -translate-x-full group-hover:translate-x-full transition-transform duration-[2000ms] pointer-events-none" />
            </h2>
            <p className="text-gray-400 text-lg font-light leading-relaxed max-w-2xl mx-auto mt-6">
              ...
              No degraded modes. <span className="text-emerald-500/80 font-mono text-sm">Fail-Closed Silicon Gate.</span>
            </p>
          </motion.div>
          ...
          >
            <div className="p-10 rounded-[2.5rem] bg-white/[0.01] border border-white/5 space-y-3 hover:border-emerald-500/40 transition-all duration-700 group relative overflow-hidden backdrop-blur-3xl">
              <div className="absolute -inset-1 bg-emerald-500/5 blur-xl opacity-0 group-hover:opacity-100 transition-opacity" />
              <div className="text-5xl font-black text-white group-hover:scale-110 transition-transform duration-500 relative z-10">0</div>
              <div className="text-[10px] text-gray-500 uppercase tracking-widest font-black italic relative z-10 group-hover:text-emerald-400 transition-colors">Simulation Modes</div>
            </div>
            <div className="p-10 rounded-[2.5rem] bg-white/[0.01] border border-white/5 space-y-3 hover:border-sky-500/40 transition-all duration-700 group relative overflow-hidden backdrop-blur-3xl">
              <div className="absolute -inset-1 bg-sky-500/5 blur-xl opacity-0 group-hover:opacity-100 transition-opacity" />
              <div className="text-5xl font-black text-white group-hover:scale-110 transition-transform duration-500 relative z-10">100%</div>
              <div className="text-[10px] text-gray-500 uppercase tracking-widest font-black italic relative z-10 group-hover:text-sky-400 transition-colors">Cryptographic Proofs</div>
            </div>
            <div className="p-10 rounded-[2.5rem] bg-white/[0.01] border border-white/5 space-y-3 hover:border-primary/40 transition-all duration-700 group relative overflow-hidden backdrop-blur-3xl">
              <div className="absolute -inset-1 bg-primary/5 blur-xl opacity-0 group-hover:opacity-100 transition-opacity" />
              <div className="text-5xl font-black text-primary group-hover:scale-110 transition-transform duration-500 relative z-10">∞</div>
              <div className="text-[10px] text-gray-400 uppercase tracking-widest font-black italic relative z-10 group-hover:text-primary transition-colors">Legal Defensibility</div>
            </div>
          </motion.div>
        </div>
      </section>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                {[
                    ...
                    { 
                        ...
                        icon: <SovereignGlyph type="lazarus" size={32} color="#9ca3af" />,
                    ...
                    { 
                        ...
                        icon: <SovereignGlyph type="ledger" size={32} color="#3a86ff" />,
                    ...
                    { 
                        ...
                        icon: <SovereignGlyph type="cerberus" size={32} color="#10b981" />,
                    ...
                    { 
                        ...
                        icon: <SovereignGlyph type="transmutator" size={32} color="#9ca3af" />,
      ...
      >
        ...
        <div className="max-w-6xl mx-auto space-y-24">
           <div className="grid lg:grid-cols-2 gap-20 items-start">
                ...
                <div className="space-y-4">
                    <FAQItem 
              question="What exactly is the GUAW Kernel?"
              answer="It's a low-latency infrastructure layer that provides physics-based verification and auditability. It does not identify who you are; it verifies that someone real is present."
                    ...
                    <FAQItem 
                        ...
                        answer={<span>The client owns their operational data. GUAW acts solely as a <strong className="text-white">technical steward</strong>, preserving integrity and auditability without asserting ownership.</span>}
                        isOpen={openFaq === 1}
                    ...
                    <FAQItem 
              question="Can GUAW be used outside traditional web applications?"
        answer="Yes. GUAW is environment-agnostic. It is a verification layer designed for any interactive system where distinguishing organic presence from synthetic execution is critical—including high-frequency trading and IoT."
                        isOpen={openFaq === 4}
                        toggle={() => setOpenFaq(openFaq === 4 ? null : 4)}
                    />

                    <FAQItem 
                        question="GUAW Kernel vs. Media Guardian: What's the difference?"
                        answer={<span>The <strong className="text-white">GUAW Kernel</strong> verifies Human Presence (liveness and micro-interaction) to prevent bots. The <strong className="text-white">Media Guardian (Web SDK)</strong> verifies content integrity (detecting AI/deepfakes) by analyzing sensor-level physics.</span>}
                        isOpen={openFaq === 5}
                        toggle={() => setOpenFaq(openFaq === 5 ? null : 5)}
                    />

                    <FAQItem 
                        question="Does GUAW store my media files?" 
                        answer="No. Media verification performs sensor-noise analysis locally. We only store the ZK-Integrity Hash to prove the media was real at the moment of capture, without maintaining the original content."
                        isOpen={openFaq === 6}
                        toggle={() => setOpenFaq(openFaq === 6 ? null : 6)}
                    />

                    <FAQItem 
                        question="Infrastructure vs. Sovereign Tier: Which do I need?" 
                        answer="Infrastructure Tiers are for self-service developers who need API access. The Sovereign Tier is for high-responsibility environments that require dedicated hardware, custom ZK-Proof workflows, and HSM Engineering for legal admissibility."
                        isOpen={openFaq === 7}
        ...
        <div className="max-w-6xl mx-auto space-y-20">
            <div className="text-center space-y-6 max-w-3xl mx-auto relative group">
                ...
                <div className="flex justify-center mt-12 pb-4">
                    <div className="p-1 rounded-2xl bg-white/5 border border-white/10 flex items-center shadow-2xl relative">
                        <button 
                            onClick={() => setBillingCycle('monthly')}
                            className={`px-8 py-3 rounded-xl text-[10px] font-black uppercase tracking-widest transition-all z-10 ${billingCycle === 'monthly' ? 'bg-white text-black shadow-[0_5px_20px_rgba(255,255,255,0.2)]' : 'text-gray-500 hover:text-white'}`}
                        >
                            Monthly
                        </button>
                        <button 
                            onClick={() => setBillingCycle('annual')}
                            className={`px-8 py-3 rounded-xl text-[10px] font-black uppercase tracking-widest transition-all z-10 relative group ${billingCycle === 'annual' ? 'bg-white text-black shadow-[0_5px_20px_rgba(255,255,255,0.2)]' : 'text-gray-500 hover:text-white'}`}
                        >
                            Annual
                            <span className="absolute -top-3 -right-3 bg-emerald-500 text-black text-[7px] px-2 py-0.5 rounded-full font-black animate-pulse shadow-[0_0_10px_rgba(16,185,129,0.4)] whitespace-nowrap">
                                2 MONTHS FREE
                            </span>
                        </button>
                    </div>
            ...
            <div className="space-y-12">
                <div className="flex items-center gap-4 justify-center">
                    ...
                    <span className="text-[10px] font-black uppercase tracking-[0.4em] text-emerald-500/60 italic animate-pulse">Operational Beta Phase</span>
                    <div className="h-px w-12 bg-emerald-500/20" />
                </div>
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-12">
                    ...
                    <div className="p-8 rounded-[3rem] bg-black/40 border border-white/5 space-y-6 group hover:border-white/20 transition-all duration-700 flex flex-col relative overflow-hidden">
                        ...
                        <div className="space-y-3 relative z-10">
                            ...
                            <h3 className="text-2xl font-black text-white italic">Trial</h3>
                        ...
                        <ul className="space-y-4 text-[10px] text-gray-500 border-t border-white/5 pt-8 flex-1 relative z-10">
                            ...
                            <li className="flex items-center gap-3 line-through opacity-30 italic"><FileCheck size={14} /> ZK-Proof</li>
                            <li className="flex items-center gap-3 line-through opacity-30 italic"><FileCheck size={14} /> Forensic Chain</li>
                        </ul>
                        <Link to="/console/register" className="block w-full py-5 rounded-2xl bg-white/5 border border-white/10 text-white font-black text-center text-[10px] uppercase tracking-widest hover:bg-white hover:text-black transition-all relative z-10">
                            Start Free Trial
                        </Link>
                    </div>

                    {/* Lite */}
                    <div className="p-8 rounded-[3rem] bg-black/40 border border-blue-500/20 space-y-6 group hover:border-blue-500/40 transition-all duration-700 flex flex-col relative overflow-hidden backdrop-blur-2xl">
                        ...
                        <div className="space-y-3 relative z-10">
                            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-blue-500/10 text-blue-400 text-[8px] font-black uppercase tracking-widest border border-blue-500/20">
                                Layer 1 Only
                            </div>
                            <h3 className="text-2xl font-black text-white italic">Lite</h3>
                            <p className="text-blue-400/70 text-[10px] leading-relaxed italic uppercase tracking-tighter">Ultimate reCAPTCHA replacement.</p>
                        </div>
                        <div className="flex items-baseline gap-1 relative z-10">
                        ...
                        <ul className="space-y-4 text-[10px] text-gray-400 border-t border-blue-500/10 pt-8 flex-1 relative z-10">
                            <li className="flex items-center gap-3 italic"><div className="w-1 h-1 rounded-full bg-blue-500/60" /> 100k req/month · 2 domains</li>
                            <li className="flex items-center gap-3 italic text-blue-400"><FileCheck size={16} /> <span className="font-black uppercase">Presence SDK Included</span></li>
                            <li className="flex items-center gap-3 line-through opacity-30 italic"><div className="w-1 h-1 rounded-full bg-blue-500/60" /> Media / Deepfake Detection</li>
                            <li className="flex items-center gap-3 line-through opacity-30 italic"><div className="w-1 h-1 rounded-full bg-blue-500/60" /> ZK-Proofs</li>
                        </ul>
                        <Link to="/console/register" className="block w-full py-5 rounded-2xl bg-blue-500/20 border border-blue-500/30 text-blue-300 font-black text-center text-[10px] uppercase tracking-widest hover:bg-blue-500 hover:text-black transition-all relative z-10">
                            Deploy in 5 min
                        </Link>
                    </div>
                    ...
                    <div className="p-8 rounded-[3rem] bg-black/40 border border-emerald-500/20 space-y-6 group hover:border-emerald-500/40 transition-all duration-700 flex flex-col relative overflow-hidden backdrop-blur-2xl">
                        ...
                        <div className="space-y-3 relative z-10">
                            ...
                            <h3 className="text-2xl font-black text-white italic">Starter</h3>
                        ...
                        <ul className="space-y-4 text-[10px] text-gray-400 border-t border-emerald-500/10 pt-8 flex-1 relative z-10">
                            ...
                            <li className="flex items-center gap-3 italic"><FileCheck size={16} className="text-emerald-400" /> <span className="font-black uppercase">ZK-Proof Included</span></li>
                        ...
                        <Link to="/console/register" className="block w-full py-5 rounded-2xl bg-emerald-500/20 border border-emerald-500/30 text-emerald-300 font-black text-center text-[10px] uppercase tracking-widest hover:bg-emerald-500 hover:text-black transition-all relative z-10">
                            Get API Key
                        </Link>
                    </div>
                </div>
            ...
            <div className="space-y-12 mt-32">
                <div className="flex items-center gap-4 justify-center">
                    ...
                    <span className="text-[10px] font-black uppercase tracking-[0.4em] text-gray-700 italic">Future Architecture Roadmap</span>
                    <div className="h-px w-12 bg-white/5" />
                </div>
                <div className="grid md:grid-cols-2 gap-12 max-w-4xl mx-auto opacity-30 grayscale filter blur-[0.5px] hover:blur-0 hover:opacity-50 transition-all duration-700">
                    {/* Pro — Roadmap */}
                    ...
                    <div className="p-8 rounded-[3rem] bg-black/40 border border-white/5 space-y-6 flex flex-col relative overflow-hidden">
                        ...
                        <ul className="space-y-4 text-[10px] text-gray-500 border-t border-white/5 pt-8 relative z-10 flex-1">
                            <li className="flex items-center gap-3 italic"><div className="w-1 h-1 rounded-full bg-white/20" /> 1.5M req/month · Unlimited</li>
            ...
            {/* Sovereign Tier — full width row */}
            <div className="mt-6 p-10 rounded-[4rem] bg-gradient-to-br from-emerald-500/5 to-transparent border border-emerald-500/20 group hover:border-emerald-500/40 transition-all duration-700 relative overflow-hidden backdrop-blur-3xl">
                ...
                <div className="flex flex-col md:flex-row items-center justify-between gap-8 relative z-10">
                    <div className="space-y-4">
                        <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-emerald-500/10 text-emerald-500 text-[9px] font-black uppercase tracking-[0.2em] border border-emerald-500/20">
                    ...
                    <div className="flex flex-col sm:flex-row items-center gap-8">
                        <div className="flex items-center gap-3 text-[10px] italic">
                            <span className="w-2 h-2 rounded-full bg-emerald-500 animate-pulse shadow-[0_0_15px_rgba(239,68,68,0.9)]" />
                            <span className="text-emerald-500 font-black uppercase tracking-widest">Pricing: Custom Engineering</span>
                        </div>
                        <Link to="/contact" className="flex-shrink-0 px-12 py-6 rounded-2xl bg-emerald-500 text-black font-black text-[11px] uppercase tracking-[0.3em] hover:scale-[1.05] transition-all shadow-[0_15px_50px_-10px_rgba(239,68,68,0.4)]">
                            Consultation
                        </Link>
                    </div>
                </div>
      ...
      <footer className="py-20 px-4 border-t border-white/5 bg-black text-center relative z-10">
        <div className="max-w-5xl mx-auto space-y-8">
            <div className="flex flex-col md:flex-row justify-center items-center gap-4 md:gap-12 text-[10px] font-mono text-gray-600 uppercase tracking-[0.2em]">
                ...
                <Link to="/acceptable-use" className="hover:text-primary transition-colors">Acceptable Use Policy (AUP)</Link>
                <Link to="/legal" className="hover:text-primary transition-colors">Sovereign Privacy Standard</Link>
                <a href="https://github.com/bluepablo/guaw-forensic-kit" target="_blank" rel="noopener noreferrer" className="hover:text-emerald-400 transition-colors">Forensic Verification Kit</a>
